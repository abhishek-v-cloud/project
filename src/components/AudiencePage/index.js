...
class AudiencePage extends Component {
  ...
  componentDidMount() {
    ...
    const roleStr = searchParams.get('role') || 'audience' // Default to audience
  ...
  initializeMeeting() {
    ...
    // Start the meeting for the audience (no additional links needed)
    ...
    return (
      <>
        ...
        <div className="user-live-conatiner">
          ...
          <div className="user-streaming-card" ref={this.containerRef}></div>
        </div>
      </>
    )
  }
